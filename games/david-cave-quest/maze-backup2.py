...
for index in range(10):
    bullet = {
        "image" : pygame.image.load("assets/bullet2.png"),
...
while True:
        ...
        for row in levelmap:
            for col in row:
                ...
                if col == "E":
                    floors.append(pygame.Rect(x, y, block_width, block_height))
                    enemy = {
                        "image":pygame.image.load("assets/sprite-older.png"),
    ...
    if key[pygame.K_z]:
        ...
        if weapon_num % 2 == 0:
            weapon = "potato"
            bullet['image'] = pygame.image.load("assets/bullet2.png")
            print(weapon)
...
#        DrawText(npc2['text'], text_rect)
    ...
    DrawText("level: " + str(level), (8, 768))
